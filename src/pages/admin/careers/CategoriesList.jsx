...
import { FiEdit, FiTrash2, FiPlus, FiBriefcase } from "react-icons/fi";
...
const JobCategoriesList = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (editingId) {
        ...
        // await adminService.updateJobCategory(editingId, formData)
        alert("Category updated successfully");
      } else {
        // Create new category
        // await adminService.createJobCategory(formData)
  ...
  const handleDelete = async (categoryId) => {
    if (
      ...
      try {
        // await adminService.deleteJobCategory(categoryId)
        ...
        <div className="bg-white rounded-lg shadow-md overflow-hidden">
          {loading ? (
            ...
            <div className="flex flex-col items-center justify-center h-64">
              ...
              <p className="text-gray-500 text-lg">No job categories found</p>
