...
function FloatingWhatsApp() {
  return (
    <aside className="fixed bottom-6 right-6 z-40">
      <a
        href="https://wa.me/4915901149844?text=Hello%20AOCA%20Resources,%20I%20am%20interested%20in%20enrolling%20in%20your%20courses."
        target="_blank"
        rel="noreferrer"
        ...
        <div className="flex flex-col text-left">
          ...
          <button
            ...
            onClick={(e) => {
              e.preventDefault();
              e.stopPropagation();
              window.location.href = 'tel:+2348161910975';
            }}
            className="font-bold text-xs hover:text-secondary-fixed transition-colors text-left"
          >
            +234 816 191 0975
          </button>
        </div>
